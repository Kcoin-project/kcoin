...
export KCOINCLI=${BUILDDIR}/qa/pull-tester/run-kcoin-cli
export KCOIND=${REAL_KCOIND}
...
if [ "x${ENABLE_KCOIND}${ENABLE_UTILS}${ENABLE_WALLET}" = "x111" ]; then
  ...
  echo "No rpc tests to run. Wallet, utils, and kcoind must all be enabled"
fi
