# mininode.py - Kcoin P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a kcoin node
...
# Objects that map to kcoind objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in kcoind indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest"):
        ...
        print 'MiniNode: Connecting to Kcoin Node IP # ' + dstaddr + ':' \
            + str(dstport)
