...
{
    BOOST_CHECK(TestSplitHost("www.kcoin.org", "www.kcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.kcoin.org]", "www.kcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.kcoin.org:80", "www.kcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.kcoin.org]:80", "www.kcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:29444", "127.0.0.1", 29444));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:29444", "127.0.0.1", 29444));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:29444", "::ffff:127.0.0.1", 29444));
    BOOST_CHECK(TestSplitHost("[::]:29444", "::", 29444));
    BOOST_CHECK(TestSplitHost("::29444", "::29444", -1));
    BOOST_CHECK(TestSplitHost(":29444", "", 29444));
    BOOST_CHECK(TestSplitHost("[]:29444", "", 29444));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:29444", "127.0.0.1:29444"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:29444", "[::]:29444"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
