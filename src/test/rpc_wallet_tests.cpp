...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CKcoinAddress demoAddress = CKcoinAddress(CTxDestination(demoPubkey.GetID()));
    UniValue retValue;
    ...
    CKcoinAddress setaccountDemoAddress = CKcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CKcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CKcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
