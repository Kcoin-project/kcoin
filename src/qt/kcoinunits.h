...
#ifndef KCOIN_QT_KCOINUNITS_H
#define KCOIN_QT_KCOINUNITS_H
...
*/
class KcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KcoinUnits(QObject *parent);

    /** Kcoin units.
      @note Source: https://en.kcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KBC,
...
typedef KcoinUnits::Unit KcoinUnit;

#endif // KCOIN_QT_KCOINUNITS_H
