The following is a list of assets used in the kcoin source and their proper attribution.
...
* Kcoin Icon: (based on the original kcoin logo from Bitboy)
* Some icons are based on Stephan Hutchings Typicons
* License: MIT

### Assets Used
    src/qt/res/icons/about.png, src/qt/res/icons/about_qt.png,
    src/qt/res/icons/kcoin.icns, src/qt/res/icons/kcoin.ico,
    src/qt/res/icons/kcoin.png, src/qt/res/icons/clock*.png,
    ...
    src/qt/res/src/verify.svg, src/qt/res/src/kcoin.svg,
