...
unlocked to sign the Kcoin-Qt.app bundle.
...
allowing somebody to distribute a Kcoin-Qt.app or kcoin-qt-setup.exe with a valid
...
that the kcoin-qt.exe file inside the installer had not been tampered with.
